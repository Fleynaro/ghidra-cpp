# Test Coverage Review: services/analyzers/function_start_search/tests

## Review Metadata

- [x] **Scope:** services/analyzers/function_start_search/tests, its CMake registration, test sources, fixtures, and the architecture commits 778c5d87ad and 3c123d1fda.
- [x] **Date:** 2026-09-16.
...
- [x] Existing files: function_start_search_tests.cppm.
...
### TEST-SERVICES_ANALYZERS_FUNCTION_START_SEARCH_TESTS-MEDIUM-001: Function-start search lacks complete corpus and architecture matrix

- [ ] **Remediation status:** Open.
- **Affected component:** services/analyzers/function_start_search/tests.
- **Source references:** function_start_search_tests.cppm. CMake registration is in `../CMakeLists.txt` where present.
- **Technical evidence:** Tests do not cover all pattern vectors, overlapping/alignment boundaries, section edges, alternate languages, or candidate invalidation.
- **Expected behavior:** The suite proves the component contract through valid, invalid, failure, and runtime-composed cases.
- **Actual behavior:** Tests do not cover all pattern vectors, overlapping/alignment boundaries, section edges, alternate languages, or candidate invalidation.
...
- [ ] Complete pattern corpus and false positives.
- [ ] Overlap/unaligned/section-boundary cases.
- [ ] Alternate language and re-analysis.

# Test Coverage Review: services/analyzers/decompiler_switch_analysis/tests

## Review Metadata

- [x] **Scope:** services/analyzers/decompiler_switch_analysis/tests, its CMake registration, test sources, fixtures, and the architecture commits 778c5d87ad and 3c123d1fda.
- [x] **Date:** 2026-09-16.
...
- [x] Existing files: decompiler_switch_analysis_tests.cppm.
...
### TEST-SERVICES_ANALYZERS_DECOMPILER_SWITCH_ANALYSIS_TESTS-HIGH-001: Switch analysis lacks durable CFG/reference coverage

- [ ] **Remediation status:** Open.
- **Affected component:** services/analyzers/decompiler_switch_analysis/tests.
- **Source references:** decompiler_switch_analysis_tests.cppm. CMake registration is in `../CMakeLists.txt` where present.
- **Technical evidence:** Tests do not assert direct/indirect jump tables, malformed tables, switch edges, and re-analysis cleanup.
- **Expected behavior:** The suite proves the component contract through valid, invalid, failure, and runtime-composed cases.
- **Actual behavior:** Tests do not assert direct/indirect jump tables, malformed tables, switch edges, and re-analysis cleanup.
...
- [ ] Direct and indirect switch fixtures.
- [ ] Malformed/partial table diagnostics.
- [ ] Durable reference/CFG event replay.

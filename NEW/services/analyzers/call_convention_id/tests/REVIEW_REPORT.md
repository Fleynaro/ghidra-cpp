# Test Coverage Review: services/analyzers/call_convention_id/tests

## Review Metadata

- [x] **Scope:** services/analyzers/call_convention_id/tests, its CMake registration, test sources, fixtures, and the architecture commits 778c5d87ad and 3c123d1fda.
- [x] **Date:** 2026-09-16.
...
- [x] Existing files: call_convention_id_tests.cppm.
...
### TEST-SERVICES_ANALYZERS_CALL_CONVENTION_ID_TESTS-MEDIUM-001: Important contract coverage is missing

- [ ] **Remediation status:** Open.
- **Affected component:** services/analyzers/call_convention_id/tests.
- **Source references:** call_convention_id_tests.cppm. CMake registration is in `../CMakeLists.txt` where present.

# Test Coverage Review: services/analyzers/stack/tests
...
- [x] Existing files: stack_tests.cppm.
...
### TEST-SERVICES_ANALYZERS_STACK_TESTS-MEDIUM-001: Important contract coverage is missing

- [ ] **Remediation status:** Open.
- **Affected component:** services/analyzers/stack/tests.
- **Source references:** stack_tests.cppm. CMake registration is in `../CMakeLists.txt` where present.

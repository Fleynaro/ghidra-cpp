# Test Coverage Review: services/analyzers/non_returning_functions_discovered/tests

## Review Metadata

- [x] **Scope:** services/analyzers/non_returning_functions_discovered/tests, its CMake registration, test sources, fixtures, and the architecture commits 778c5d87ad and 3c123d1fda.
- [x] **Date:** 2026-09-16.
...
### TEST-SERVICES_ANALYZERS_NON_RETURNING_FUNCTIONS_DISCOVERED_TESTS-HIGH-001: Analyzer scaffold has no test source

- [ ] **Remediation status:** Open.
- **Affected component:** services/analyzers/non_returning_functions_discovered/tests.
...
- **Technical evidence:** No test source exists for discovered no-return propagation.
- **Expected behavior:** The suite proves the component contract through valid, invalid, failure, and runtime-composed cases.
- **Actual behavior:** No test source exists for discovered no-return propagation.
...
- [ ] Known positive/negative no-return propagation.
- [ ] Caller propagation and re-analysis.
- [ ] Flow/function-flag event persistence.

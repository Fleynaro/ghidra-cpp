# Test Coverage Review: services/analyzers/shared/tests

## Review Metadata

- [x] **Scope:** services/analyzers/shared/tests, its CMake registration, test sources, fixtures, and the architecture commits 778c5d87ad and 3c123d1fda.
- [x] **Date:** 2026-09-16.
...
- [x] Existing files: CMakeLists.txt, function_body_tests.cppm.
...
### TEST-SERVICES_ANALYZERS_SHARED_TESTS-HIGH-001: Analyzer shared framework lacks snapshot/transaction concurrency tests

- [ ] **Remediation status:** Open.
- **Affected component:** services/analyzers/shared/tests.
- **Source references:** function_body_tests.cppm. CMake registration is in `../CMakeLists.txt` where present.
- **Technical evidence:** Function-body tests do not prove immutable snapshot isolation, revision conflicts, removal semantics, concurrent readers, or rollback.
- **Expected behavior:** The suite proves the component contract through valid, invalid, failure, and runtime-composed cases.
- **Actual behavior:** Function-body tests do not prove immutable snapshot isolation, revision conflicts, removal semantics, concurrent readers, or rollback.
...
- [ ] Snapshot isolation and revision conflicts.
- [ ] Removal/re-analysis behavior.
- [ ] Concurrent reads and serial mutations.

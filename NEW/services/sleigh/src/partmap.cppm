...
public:
    /// Look up the first split point coming before the given point and return the value object it maps to.
    /// If there is no earlier split point return the default value.

...
union alignas(8) simd64_t {
    ...
    simd64_t& operator=(uint64_t x) {
        u64[0] = x;
        return *this;
    }
    simd64_t& operator=(int64_t x) {
        s64[0] = x;
        return *this;
    }
    ...
    operator __m64 const&() const {
        return value;
    } // Reference because otherwise the MSVC compiler incorrectly complains about the lack of EMMS.
    simd64_t& operator=(__m64 x) {
        value = x;
        return *this;
    }
    ...
    operator __n64() const {
        return value;
    }
    simd64_t& operator=(__n64 x) {
        value = x;
        return *this;
    }
#endif
...
union alignas(16) simd128_t {
    ...
    simd128_t& operator=(__m128 x) {
        value = _mm_castps_si128(x);
        return *this;
    }
    simd128_t& operator=(__m128d x) {
        value = _mm_castpd_si128(x);
        return *this;
    }
#endif // !__clang__
#elif TTD_IS_ARM64_CPU
...
union alignas(32) simd256_t {
    ...
    simd256_t& operator=(__m256 x) {
        value = _mm256_castps_si256(x);
        return *this;
    }
    simd256_t& operator=(__m256d x) {
        value = _mm256_castpd_si256(x);
        return *this;
    }
#endif // !__clang__
#elif TTD_IS_ARM64_CPU
    ...
    operator __n128x2() const {
        return value;
    }
    simd256_t& operator=(__n128x2 x) {
        value = x;
        return *this;
    }
#endif
...
union alignas(64) simd512_t {
    ...
    simd512_t& operator=(__m512 x) {
        value = _mm512_castps_si512(x);
        return *this;
    }
    simd512_t& operator=(__m512d x) {
        value = _mm512_castpd_si512(x);
        return *this;
    }
#endif // !__clang__
#elif TTD_IS_ARM64_CPU
    ...
    operator __n128x4() const {
        return value;
    }
    simd512_t& operator=(__n128x4 x) {
        value = x;
        return *this;
    }
#endif
...
#define TTD_DEFINE_ENUM_FLAG_OPERATORS(ENUMTYPE)                                                                       \
    ...
    constexpr bool operator!(ENUMTYPE a) {                                                                             \
        return static_cast<std::underlying_type_t<ENUMTYPE>>(a) == static_cast<std::underlying_type_t<ENUMTYPE>>(0);   \
    }                                                                                                                  \
...
// Offset functions.
__forceinline constexpr GuestAddress operator+(GuestAddress addr, int64_t value) {
    return static_cast<GuestAddress>(static_cast<uint64_t>(addr) + value);
}
__forceinline constexpr GuestAddress operator-(GuestAddress addr, int64_t value) {
    return static_cast<GuestAddress>(static_cast<uint64_t>(addr) - value);
}
__forceinline GuestAddress& operator+=(_Inout_ GuestAddress& addr, int64_t value) {
    return addr = static_cast<GuestAddress>(static_cast<uint64_t>(addr) + value);
}
__forceinline GuestAddress& operator-=(_Inout_ GuestAddress& addr, int64_t value) {
    return addr = static_cast<GuestAddress>(static_cast<uint64_t>(addr) - value);
}
...
__forceinline constexpr int64_t operator-(GuestAddress addr1, GuestAddress addr2) {
    return static_cast<int64_t>(addr1) - static_cast<int64_t>(addr2);
}

// Bit twiddling.
__forceinline constexpr uint64_t operator~(GuestAddress addr) {
    return ~static_cast<uint64_t>(addr);
}
__forceinline constexpr GuestAddress operator&(GuestAddress addr1, uint64_t num2) {
    return static_cast<GuestAddress>(static_cast<uint64_t>(addr1) & num2);
}
__forceinline constexpr GuestAddress operator|(GuestAddress addr1, uint64_t num2) {
    return static_cast<GuestAddress>(static_cast<uint64_t>(addr1) | num2);
}
...
__forceinline constexpr GuestAddress operator&(GuestAddress addr1, GuestAddress addr2) {
    return addr1 & static_cast<uint64_t>(addr2);
}
__forceinline constexpr GuestAddress operator|(GuestAddress addr1, GuestAddress addr2) {
    return addr1 | static_cast<uint64_t>(addr2);
}
...
__forceinline constexpr uint64_t operator%(GuestAddress addr1, uint64_t num2) {
    return static_cast<uint64_t>(addr1) % num2;
}
...
__forceinline GuestAddress PtrToGuestAddress(void const volatile* ptr) {
    return static_cast<GuestAddress>(reinterpret_cast<uintptr_t>(ptr));
}

template <typename T = void const> __forceinline T* GuestAddressToPtr(GuestAddress addr) {
...
constexpr bool operator==(GuestAddressRange const& a, GuestAddressRange const& b) {
...
enum class SelectRegisters : uint8_t { None = 0, BasicRegisters = 1, ExtendedRegisters = 2, AllRegisters = 3 };
...
enum class ProcessorArchitecture : uint8_t {
    ...
    x64 = 2,
    ARM32 = 3,
    Arm64 = 4, // Note: on the arm64 build, the build system define a ARM64 macro that would conflict with the constant
               // we are defining here
};

constexpr char const* GetProcessorArchitectureName(ProcessorArchitecture architecture) {
    switch (architecture) {
        case ProcessorArchitecture::Invalid:
            return "Invalid";
...
constexpr GuestAddress SanitizeAddressForUserMode(ProcessorArchitecture const architecture,
                                                  GuestAddress const address) {
    switch (architecture) {
        case ProcessorArchitecture::x86:
        case ProcessorArchitecture::ARM32:
...
constexpr wchar_t const* GetInjectModeName(InjectMode const injectMode) noexcept {
    switch (injectMode) {
        case InjectMode::LoaderForRecording:
            return L"LoaderForRecording";
        case InjectMode::LoaderForCombinedRecording:
            return L"LoaderForCombinedRecording";
        case InjectMode::LoaderForEmulator:
            return L"LoaderForEmulator";
        case InjectMode::EmulatorForRecording:
            return L"EmulatorForRecording";
        case InjectMode::EmulatorOnly:
            return L"EmulatorOnly";
...
enum class FindValidDataLineMode : uint32_t { IncludePreviouslyReturnedDataLines, ExcludePreviouslyReturnedDataLines };
...
constexpr char const* GetReplayCpuSupportName(ReplayCpuSupport const support) {
    switch (support) {
        case ReplayCpuSupport::Default:
            return "Default";
        case ReplayCpuSupport::MostConservative:
            return "MostConservative";
        case ReplayCpuSupport::MostAggressive:
            return "MostAggressive";
        case ReplayCpuSupport::IntelAvx2Required:
            return "IntelAvx2Required";
        case ReplayCpuSupport::IntelAvxRequired:
            return "IntelAvxRequired";
        default:
            return "<unknown ReplayCpuSupport>";
    }
}

enum class ErrorCheckingLevel : uint8_t { Off = 0, Minimum = 1, Debug = 2, Paranoid = 3 };
...
inline uint64_t GetErrorCheckingLevelInterval(ErrorCheckingLevel level) {
    switch (level) {
        case ErrorCheckingLevel::Minimum:
            return 1000u;
        case ErrorCheckingLevel::Debug:
            return 10u;
        case ErrorCheckingLevel::Paranoid:
            return 1u;
        default:
            return 0x7FFF'FFFF'FFFF'FFFFllu;
    }
}

inline char const* GetErrorCheckingLevelName(ErrorCheckingLevel level) {
    switch (level) {
        case ErrorCheckingLevel::Off:
            return "Off";
        case ErrorCheckingLevel::Minimum:
            return "Minimum";
        case ErrorCheckingLevel::Debug:
...
__forceinline SequenceId operator+(SequenceId addr, int64_t value) {
    return static_cast<SequenceId>(static_cast<uint64_t>(addr) + value);
}
__forceinline SequenceId operator-(SequenceId addr, int64_t value) {
    return static_cast<SequenceId>(static_cast<uint64_t>(addr) - value);
}
__forceinline SequenceId& operator+=(_Inout_ SequenceId& addr, int64_t value) {
    return addr = static_cast<SequenceId>(static_cast<uint64_t>(addr) + value);
}
__forceinline SequenceId& operator-=(_Inout_ SequenceId& addr, int64_t value) {
    return addr = static_cast<SequenceId>(static_cast<uint64_t>(addr) - value);
}
...
template <bool TIsConst> struct TBufferView {
    ...
    __forceinline TBufferView(_Notnull_ PtrType baseAddress, size_t size) : BaseAddress(baseAddress), Size(size) {
        DBG_ASSERT(IsValid());
    }

    __forceinline TBufferView(_Pre_ptrdiff_cap_(endAddress) _Notnull_ PtrType baseAddress,
                              _Notnull_ void const* endAddress)
        : BaseAddress(baseAddress), Size(PointerDiffInBytes(endAddress, baseAddress)) {
        DBG_ASSERT(endAddress >= baseAddress);
        DBG_ASSERT(IsValid());
    }

    __forceinline bool IsValid() const {
        return (BaseAddress != nullptr && Size > 0) || (BaseAddress == nullptr && Size == 0);
    }
    ...
    template <typename T> PointerToT<T> __fastcall AsPointerTo() const {
        DBG_ASSERT(IsValid());
        return static_cast<PointerToT<T>>(BaseAddress);
    }

    template <typename T> PointerToT<T> __fastcall EndAsPointerTo() const {
        DBG_ASSERT(IsValid());
        return static_cast<PointerToT<T>>(GetEndAddress());
    }

    friend __forceinline bool operator==(TBufferView const& b1, TBufferView const& b2) {
        DBG_ASSERT(b1.IsValid());
        DBG_ASSERT(b2.IsValid());
        return b1.BaseAddress == b2.BaseAddress && b1.Size == b2.Size;
    }
    friend __forceinline bool operator<(TBufferView const& b1, TBufferView const& b2) {
        DBG_ASSERT(b1.IsValid());
        DBG_ASSERT(b2.IsValid());
        return b1.BaseAddress < b2.BaseAddress || (b1.BaseAddress == b2.BaseAddress && b1.Size < b2.Size);
    }
    friend __forceinline bool operator<=(TBufferView const& b1, TBufferView const& b2) {
        DBG_ASSERT(b1.IsValid());
        DBG_ASSERT(b2.IsValid());
    ...
    __forceinline PtrType GetEndAddress() const {
        DBG_ASSERT(IsValid());
        return reinterpret_cast<PtrType>(reinterpret_cast<uintptr_t>(BaseAddress) + Size);
    }

...
- Tests use the unified recorder under [`../recorder`](../recorder), the existing multi-thread debuggee, and real `.run`/`.idx` artifacts prepared by `NEW\build.bat ttd_all`.

...
// Port provenance: mechanically copied from Ghidra/Features/Decompiler/src/decompile/cpp/printjava.cc.
...
PrintJava::PrintJava(Architecture* glb, const string& nm)
    : PrintC(glb, nm)

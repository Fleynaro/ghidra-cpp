...
// Port provenance: mechanically copied from Ghidra/Features/Decompiler/src/decompile/cpp/stringmanage.cc.
...
void StringManager::assignStringData(StringData& data, const uint1* buf, int4 size, int4 charsize, int4 numChars,
                                     bool bigend)
...
StringManagerUnicode::StringManagerUnicode(Architecture* g, int4 max) : StringManager(max) {
    glb = g;

...
// Port provenance: mechanically copied from Ghidra/Features/Decompiler/src/decompile/cpp/memstate.cc.
...
MemoryImage::MemoryImage(AddrSpace* spc, int4 ws, int4 ps, LoadImage* ld) : MemoryBank(spc, ws, ps) {
    loader = ld;
}
...
MemoryPageOverlay::MemoryPageOverlay(AddrSpace* spc, int4 ws, int4 ps, MemoryBank* ul) : MemoryBank(spc, ws, ps) {
    underlie = ul;
}

...
public:
    ...
    /// Uses compiler-generated destruction for all owned strings.
...
public:
    ...
    virtual void startPrefixMapping(const string& prefix,
                                    const string& uri) = 0;  ///< Start a new prefix to namespace URI mapping
    ...
    virtual void startElement(const string& namespaceURI, const string& localName, const string& qualifiedName,
...
public:
    ...
    explicit Element(Element* par) : parent(par) {}

    /// Releases all owned descendants through RAII.
    ...
    ///
    /// \param child is the newly allocated child whose ownership is transferred
    void addChild(std::unique_ptr<Element> child) {
        Element* child_view = child.get();

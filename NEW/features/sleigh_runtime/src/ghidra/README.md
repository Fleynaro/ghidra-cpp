...
The public adapter is [`../../sleigh_runtime_adapter.cppm`](../../sleigh_runtime_adapter.cppm), and the module overview is [`../../README.md`](../../README.md). The private primary module is [`internal.cppm`](internal.cppm), which re-exports the self-contained partitions in this directory. The runtime-specific raw storage value is [`varnode.cppm`](varnode.cppm).

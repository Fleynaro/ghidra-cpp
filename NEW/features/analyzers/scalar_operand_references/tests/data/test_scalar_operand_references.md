...
| `0x0000000140001040` | `1` | `0x140002000` | `0x0000000140002000` | `` | `Rejected address-like control` | Pre-existing disassembly state |
| `0x0000000140001054` | `1` | `0x28` | `0x0000000000000028` | `` | `Rejected small numeric control` | Pre-existing disassembly state |
| `0x00000001400010D3` | `1` | `0x28` | `0x0000000000000028` | `` | `Rejected small numeric control` | Pre-existing disassembly state |
...
| `0x0000000140001040` | `1` | `0x140002000` | `0x0000000140002000` | `0x0000000140002000` | `Analyzer-created address reference` | Post-target operand state |
| `0x0000000140001054` | `1` | `0x28` | `0x0000000000000028` | `` | `Rejected small numeric control` | Post-target operand state |
| `0x00000001400010D3` | `1` | `0x28` | `0x0000000000000028` | `` | `Rejected small numeric control` | Post-target operand state |
...
| Changed | `0x0000000140001040` | `1` | ` / Rejected address-like control` | `0x0000000140002000 / Analyzer-created address reference` |

### Delta conclusion

- **Positive analyzer references after analysis:** `3`.
- **Negative controls without references after analysis:** `4`.
- **Rows added:** `0`; removed: `0`; changed: `3`.

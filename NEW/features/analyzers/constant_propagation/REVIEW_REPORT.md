...
- Technical evidence: unlike the other requested Java ports, `NEW/features/analyzers/constant_propagation` has `README.md` but no `GHIDRA_PORT.md`, despite the repository rule requiring port evidence for each Java feature.

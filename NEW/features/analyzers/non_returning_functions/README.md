...
Golden evidence: [`../non_returning_functions_known/tests/data/`](../non_returning_functions_known/tests/data/)
and [`../non_returning_functions_discovered/tests/data/`](../non_returning_functions_discovered/tests/data/).

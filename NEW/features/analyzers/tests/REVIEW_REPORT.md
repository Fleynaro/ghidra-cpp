...
- [x] Scope confirmed: current staged and unstaged changes under `NEW/features/analyzers`, `NEW/build.bat`, and the aggregate integration-test task context were reviewed.

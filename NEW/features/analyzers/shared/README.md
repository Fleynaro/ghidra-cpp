...
- [`src/analyzer_context.cppm`](src/analyzer_context.cppm) defines `AnalysisContext`, including PE/Sleigh ownership, disassembly, references, functions, CFGs, and observable state mutation.
...
- [`tests/function_body_tests.cppm`](tests/function_body_tests.cppm) verifies shared `AnalysisContext` body, CFG, overlap, thunk, and flow-repair behavior; its dedicated PE/oracle is under [`tests/data/`](tests/data/).

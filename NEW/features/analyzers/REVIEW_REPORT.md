...
- [x] Scope confirmed: current `NEW/features/analyzers` implementations, tests, fixture C++/RC/PDB sources, PyGhidra scripts and generated reports, module `README.md`/`GHIDRA_PORT.md`, CMake files, module/root build wrappers, and shared analyzer/test-support boundaries.
...
- Severity: critical.
- Affected component: `NEW/features/analyzers/demangler_microsoft/src/demangler_microsoft.cppm`.
...
- [ ] Remediation status: open.
- Severity: high.
- Affected component: `NEW/features/analyzers/call_fixup_installer/src/call_fixup_installer.cppm` and `NEW/features/analyzers/shared/src/analyzer_context.cppm`.
...
- [x] `NEW/features/analyzers/aggressive_instruction_finder/REVIEW_REPORT.md` records the terminal-flow failure classification and remaining ARM/scheduler gaps.
- [x] `NEW/features/analyzers/embedded_media/REVIEW_REPORT.md` records the JPEG failure classification and remaining datatype-parser gaps.
- [x] `NEW/features/analyzers/create_address_tables/REVIEW_REPORT.md` records the corrected pointer-per-entry expectation and incomplete Java algorithm.
- [x] `NEW/features/analyzers/shared_return_calls/REVIEW_REPORT.md` records the lifecycle/options gaps.

...
if not exist test_windows_pe_x86_propagate_external_parameters.pdb (
    echo ERROR: The x86 linker did not produce test_windows_pe_x86_propagate_external_parameters.pdb.
    exit /b 1
)

...
`Example6MetricSpentOnBankInterestEndToEnd` use explicit machine-code bytes and expected C
from their corresponding examples without reading Markdown at runtime. The tests feed those
bytes through the compiled Sleigh fixture at

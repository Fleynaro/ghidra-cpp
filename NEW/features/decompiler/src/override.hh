// Port provenance: mechanically copied from Ghidra/Features/Decompiler/src/decompile/cpp/override.hh.
...
public:
    ...
    public:
        ...
        static Record* allocateCallDest(const string& name,
                                        const Address& dest); ///< Return a corresponding call destination override
    };
...
public:
    ...
    bool hasPCodeOverride(void) const {
        return (!pcodeover.empty());

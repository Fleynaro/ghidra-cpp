// Port provenance: mechanically copied from Ghidra/Features/Decompiler/src/decompile/cpp/emulate.hh.
...
public:
    PcodeEmitCache(vector<PcodeOpRaw*>& ocache, vector<VarnodeData*>& vcache, const vector<OpBehavior*>& in,
                   uintb uniqReserve); ///< Constructor

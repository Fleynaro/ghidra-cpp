// Port provenance: mechanically copied from Ghidra/Features/Decompiler/src/decompile/cpp/graph.cc.
...

{
    ...
    s << "  ~ReplaceAllParams = TRUE,\n";
    s << "  "
         "Center=({SpecialColor=Black,SpecialFontName=SansSerif,Format=StandardFormat,UseSpecialFontName=false,"
         "LabelAlignment=Center,TreatBackSlashNAsNewLine=false,MaxLines=4,FontSize=10,IncludeBackground=false,"
         "SqueezeLinesTogether=true,BackgroundColor=Black,UseSpecialColor=false,AttributeName=Name,MaxWidth=100}),\n";
    s << "  East=(),\n";
    s << "  SouthEast=(),\n";
    s << "  North=(),\n";
    s << "  West=(),\n";
...

{
    ...
    s << "  ~ReplaceAllParams = TRUE,\n";
    s << "  "
         "Center=({MaxLines=4,SqueezeLinesTogether=true,TreatBackSlashNAsNewLine=false,FontSize=10,Format="
         "StandardFormat,IncludeBackground=false,BackgroundColor=Black,AttributeName=Start,UseSpecialFontName=false,"
         "SpecialColor=Black,SpecialFontName=SansSerif,UseSpecialColor=false,LabelAlignment=Center,MaxWidth=100}),\n";
    s << "  East=(),\n";
    s << "  SouthEast=(),\n";
    s << "  North=(),\n";
    s << "  West=(),\n";

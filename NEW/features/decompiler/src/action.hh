// Port provenance: mechanically copied from Ghidra/Features/Decompiler/src/decompile/cpp/action.hh.
...
public:
    ActionRestartGroup(uint4 f, const string& nm, int4 max) : ActionGroup(f, nm) {
        maxrestarts = max;
...
public:
    ...
    Action* toggleAction(const string& grp, const string& basegrp,
                         bool val); ///< Toggle a group of Actions with a \e root Action

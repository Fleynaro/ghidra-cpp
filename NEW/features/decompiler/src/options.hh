// Port provenance: mechanically copied from Ghidra/Features/Decompiler/src/decompile/cpp/options.hh.
...
public:
    ...
    string set(uint4 nameId, const string& p1 = "", const string& p2 = "",
               const string& p3 = ""); ///< Issue an option command

// Port provenance: mechanically copied from Ghidra/Features/Decompiler/src/decompile/cpp/stringmanage.hh.
...
protected:
    ...
    bool writeUnicode(ostream& s, const uint1* buffer, int4 size, int4 charsize,
                      bool bigend); ///< Translate/copy unicode to UTF8
...
public:
    ...
    static bool hasCharTerminator(const uint1* buffer, int4 size,
                                  int4 charsize);         ///< Check for a unicode string terminator
    ...
    static int4 getCodepoint(const uint1* buf, int4 charsize, bool bigend,
                             int4& skip); ///< Extract next \e unicode \e codepoint
};

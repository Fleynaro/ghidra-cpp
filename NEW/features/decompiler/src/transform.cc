// Port provenance: mechanically copied from Ghidra/Features/Decompiler/src/decompile/cpp/transform.cc.
...
bool LaneDescription::restriction(int4 numLanes, int4 skipLanes, int4 bytePos, int4 size, int4& resNumLanes,
...
bool LaneDescription::extension(int4 numLanes, int4 skipLanes, int4 bytePos, int4 size, int4& resNumLanes,
                                int4& resSkipLanes) const

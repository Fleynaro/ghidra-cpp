// Port provenance: mechanically copied from Ghidra/Features/Decompiler/src/decompile/cpp/cover.hh.
...
public:
    ...
    bool isPopulated(void) const {
        return is_pop;
    } ///< Return \b true if \b this set is populated
...
public:
    ...
    bool intersect(const PcodeOpSet& opSet,
                   Varnode* rep) const; ///< Does \b this cover any PcodeOp in the given PcodeOpSet

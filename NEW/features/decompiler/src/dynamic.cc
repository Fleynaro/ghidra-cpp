// Port provenance: mechanically copied from Ghidra/Features/Decompiler/src/decompile/cpp/dynamic.cc.
...
const uint4 DynamicHash::transtable[] = {0,
                                         CPUI_COPY,
                                         CPUI_LOAD,
                                         CPUI_STORE,
                                         CPUI_BRANCH,
                                         ...
                                         CPUI_INT_EQUAL,
                                         CPUI_INT_EQUAL, // NOT_EQUAL hashes same as EQUAL
                                         CPUI_INT_SLESS,
                                         CPUI_INT_SLESS, // SLESSEQUAL hashes same as SLESS
                                         CPUI_INT_LESS,
                                         CPUI_INT_LESS, // LESSEQUAL hashes same as LESS

                                         CPUI_INT_ZEXT,
                                         CPUI_INT_SEXT,
                                         CPUI_INT_ADD,
                                         CPUI_INT_ADD, // SUB hases same as ADD
                                         CPUI_INT_CARRY,
                                         CPUI_INT_SCARRY,
                                         CPUI_INT_SBORROW,
                                         CPUI_INT_2COMP,
                                         ...
                                         CPUI_INT_AND,
                                         CPUI_INT_OR,
                                         CPUI_INT_MULT, // LEFT hases same as MULT
                                         CPUI_INT_RIGHT,
                                         CPUI_INT_SRIGHT,
                                         CPUI_INT_MULT,
                                         CPUI_INT_DIV,
                                         ...
                                         CPUI_FLOAT_EQUAL,
                                         CPUI_FLOAT_EQUAL, // NOTEQUAL hases same as EQUAL
                                         CPUI_FLOAT_LESS,
                                         CPUI_FLOAT_LESS, // LESSEQUAL hashes same as EQUAL
                                         0,               // Unused slot - skip
                                         CPUI_FLOAT_NAN,
                                         ...
                                         CPUI_FLOAT_DIV,
                                         CPUI_FLOAT_MULT,
                                         CPUI_FLOAT_ADD, // SUB hashes same as ADD
                                         CPUI_FLOAT_NEG,
                                         CPUI_FLOAT_ABS,
                                         CPUI_FLOAT_SQRT,
                                         ...
                                         0, // CAST is skipped
                                         CPUI_INT_ADD,
                                         CPUI_INT_ADD, // PTRADD and PTRSUB hash same as INT_ADD
                                         CPUI_SEGMENTOP,
                                         CPUI_CPOOLREF,
                                         CPUI_NEW,
                                         CPUI_INSERT,
...

{
    ...
    for (ct = 0; ct < opedge.size(); ++ct) { // Find op that is directly attached to -root- i.e. not a skip op
        ...
        if ((slot < 0) && (op->getOut() == root))
            break;
        if ((slot >= 0) && (op->getIn(slot) == root))
            break;
    }

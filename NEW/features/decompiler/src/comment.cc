// Port provenance: mechanically copied from Ghidra/Features/Decompiler/src/decompile/cpp/comment.cc.
...
CommentDatabaseInternal::CommentDatabaseInternal(void) : CommentDatabase() {}
...
void CommentDatabaseInternal::addComment(uint4 tp, const Address& fad, const Address& ad, const string& txt) {
...
bool CommentDatabaseInternal::addCommentNoDuplicate(uint4 tp, const Address& fad, const Address& ad,
                                                    const string& txt) {
    Comment* newcom = new Comment(tp, fad, ad, 65535, txt);

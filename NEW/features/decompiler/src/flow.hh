// Port provenance: mechanically copied from Ghidra/Features/Decompiler/src/decompile/cpp/flow.hh.
...
public:
    enum {
        ...
        error_reinterpreted =
            0x10, ///< Throw an exception for flow into previously encountered data at a difference \e cut
...
private:
    ...
    bool hasPossibleUnreachable(void) const {
        return ((flags & possible_unreachable) != 0);
    ...
    PcodeOp* xrefControlFlow(list<PcodeOp*>::const_iterator oiter, bool& startbasic, bool& isfallthru,
                             FuncCallSpecs* fc);
...
public:
    ...
    FlowInfo(Funcdata& d, PcodeOpBank& o, BlockGraph& b, vector<FuncCallSpecs*>& q,
             const FlowInfo* op2); ///< Cloning constructor
    ...
    int4 getSize(void) const {
        return (int4)(maxaddr.getOffset() - minaddr.getOffset());

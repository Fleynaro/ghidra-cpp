// Port provenance: mechanically copied from Ghidra/Features/Decompiler/src/decompile/cpp/ruleaction.hh.
...
class AddTreeState {
    ...
    bool checkMultTerm(Varnode* vn, PcodeOp* op,
                       uint8 treeCoeff); ///< Accumulate details of INT_MULT term and continue traversal if appropriate
...
class RuleIgnoreNan : public Rule {
    ...
    static Varnode* testForComparison(Varnode* floatVar, PcodeOp* op, int4 slot, OpCode matchCode, int4& count,
                                      Funcdata& data);

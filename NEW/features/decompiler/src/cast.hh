// Port provenance: mechanically copied from Ghidra/Features/Decompiler/src/decompile/cpp/cast.hh.
...
public:
    ...
    virtual Datatype* castStandard(Datatype* reqtype, Datatype* curtype, bool care_uint_int,
                                   bool care_ptr_uint) const = 0;

// Port provenance: mechanically copied from Ghidra/Features/Decompiler/src/decompile/cpp/unify.hh.
...
public:
    ...
    virtual RHSConstant* clone(void) {
        return new ConstantNamed(constindex);
    }
...
public:
    ...
    virtual RHSConstant* clone(void) {
        return new ConstantAbsolute(val);
    }
    virtual uintb getConstant(UnifyState& state) const;
    virtual void writeExpression(ostream& s, UnifyCPrinter& printstate) const;
};
...
public:
    ConstantNZMask(int4 ind) {
        varindex = ind;
    }
    virtual RHSConstant* clone(void) {
        return new ConstantNZMask(varindex);
    }
    virtual uintb getConstant(UnifyState& state) const;
    virtual void writeExpression(ostream& s, UnifyCPrinter& printstate) const;
};
...
public:
    ConstantConsumed(int4 ind) {
        varindex = ind;
    }
    virtual RHSConstant* clone(void) {
        return new ConstantConsumed(varindex);
    }
    virtual uintb getConstant(UnifyState& state) const;
    virtual void writeExpression(ostream& s, UnifyCPrinter& printstate) const;
};
...
public:
    ConstantOffset(int4 ind) {
        varindex = ind;
    }
    virtual RHSConstant* clone(void) {
        return new ConstantOffset(varindex);
    }
    virtual uintb getConstant(UnifyState& state) const;
    virtual void writeExpression(ostream& s, UnifyCPrinter& printstate) const;
};
...
public:
    ConstantIsConstant(int4 ind) {
        varindex = ind;
    }
    virtual RHSConstant* clone(void) {
        return new ConstantIsConstant(varindex);
    }
    virtual uintb getConstant(UnifyState& state) const;
    virtual void writeExpression(ostream& s, UnifyCPrinter& printstate) const;
};
...
public:
    ConstantHeritageKnown(int4 ind) {
        varindex = ind;
    }
    virtual RHSConstant* clone(void) {
        return new ConstantHeritageKnown(varindex);
    }
    virtual uintb getConstant(UnifyState& state) const;
    virtual void writeExpression(ostream& s, UnifyCPrinter& printstate) const;
};
...
public:
    ConstantVarnodeSize(int4 ind) {
        varindex = ind;
    }
    virtual RHSConstant* clone(void) {
        return new ConstantVarnodeSize(varindex);
    }
    virtual uintb getConstant(UnifyState& state) const;
    virtual void writeExpression(ostream& s, UnifyCPrinter& printstate) const;
};
...
public:
    ConstantExpression(RHSConstant* e1, RHSConstant* e2, OpCode oc) {
        expr1 = e1;
        expr2 = e2;
        opc = oc;
    }
...
public:
    ...
    PcodeOp* getCurrentOp(void) const {
        return *iter;
    }
    void initialize(Varnode* vn) {
        onestep = false;
...
public:
    ...
    int4 getState(void) const {
        return state;
    }
    void initialize(int4 end) {
        state = -1;
        endstate = end;
    }
    bool step(void) {
...
public:
    ...
    void addTraverse(TraverseConstraint* tc) {
        traverselist.push_back(tc);
    }
    TraverseConstraint* getSubTraverse(int4 slot) const {
        return traverselist[slot];
    }
    int4 getCurrentIndex(void) const {
        return currentconstraint;
    }
    void setCurrentIndex(int4 val) {
        currentconstraint = val;
    }
    int4 getState(void) const {
        return state;
    }
    void setState(int4 val) {
        state = val;
    }
};
...
protected:
    ...
    int4 maxnum;
    UnifyConstraint* copyid(const UnifyConstraint* op) {
        uniqid = op->uniqid;
        maxnum = op->maxnum;
        return this;
    }
...
public:
    DummyOpConstraint(int4 ind) {
        maxnum = opindex = ind;
    }
    virtual UnifyConstraint* clone(void) const {
        return (new DummyOpConstraint(opindex))->copyid(this);
    }
...
public:
    DummyVarnodeConstraint(int4 ind) {
        maxnum = varindex = ind;
    }
    virtual UnifyConstraint* clone(void) const {
        return (new DummyVarnodeConstraint(varindex))->copyid(this);
    }
    virtual bool step(UnifyState& state) {
        return true;
    }
...
public:
    DummyConstConstraint(int4 ind) {
        maxnum = constindex = ind;
    }
    virtual UnifyConstraint* clone(void) const {
        return (new DummyConstConstraint(constindex))->copyid(this);
    }
    virtual bool step(UnifyState& state) {
        return true;
    }
...
public:
    ConstraintBoolean(bool ist, RHSConstant* ex) {
        istrue = ist;
        expr = ex;
        maxnum = -1;
    }
    virtual ~ConstraintBoolean(void) {
        delete expr;
    }
    virtual UnifyConstraint* clone(void) const {
        return (new ConstraintBoolean(istrue, expr->clone()))->copyid(this);
    }
    virtual bool step(UnifyState& state);
    virtual void print(ostream& s, UnifyCPrinter& printstate) const;
};
...
public:
    ConstraintVarConst(int4 ind, RHSConstant* ex, RHSConstant* sz) {
        varindex = ind;
        maxnum = ind;
        expr = ex;
        exprsz = sz;
...
public:
    ConstraintNamedExpression(int4 ind, RHSConstant* ex) {
        constindex = ind, expr = ex;
        maxnum = constindex;
    }
    virtual ~ConstraintNamedExpression(void) {
        delete expr;
    }
    virtual UnifyConstraint* clone(void) const {
        return (new ConstraintNamedExpression(constindex, expr->clone()))->copyid(this);
    }
    virtual bool step(UnifyState& state);
    virtual void collectTypes(vector<UnifyDatatype>& typelist) const;
    virtual int4 getBaseIndex(void) const {
...
public:
    ConstraintOpCopy(int4 oldind, int4 newind) {
        oldopindex = oldind;
        newopindex = newind;
        maxnum = (oldopindex > newopindex) ? oldopindex : newopindex;
    }
    virtual UnifyConstraint* clone(void) const {
        return (new ConstraintOpCopy(oldopindex, newopindex))->copyid(this);
    }
    virtual bool step(UnifyState& state);
    virtual void collectTypes(vector<UnifyDatatype>& typelist) const;
    virtual int4 getBaseIndex(void) const {
...
public:
    ConstraintOpcode(int4 ind, const vector<OpCode>& o) {
        maxnum = opindex = ind;
        opcodes = o;
    }
    const vector<OpCode>& getOpCodes(void) const {
        return opcodes;
    }
    virtual UnifyConstraint* clone(void) const {
        return (new ConstraintOpcode(opindex, opcodes))->copyid(this);
    }
    virtual bool step(UnifyState& state);
    virtual void collectTypes(vector<UnifyDatatype>& typelist) const;
    virtual int4 getBaseIndex(void) const {
...
public:
    ConstraintOpCompare(int4 op1ind, int4 op2ind, bool val) {
        op1index = op1ind;
        op2index = op2ind;
        istrue = val;
    ...
    virtual UnifyConstraint* clone(void) const {
        return (new ConstraintOpCompare(op1index, op2index, istrue))->copyid(this);
    }
    virtual bool step(UnifyState& state);
    virtual void collectTypes(vector<UnifyDatatype>& typelist) const;
    virtual int4 getBaseIndex(void) const {
...
public:
    ConstraintOpInput(int4 oind, int4 vind, int4 sl) {
        opindex = oind;
        varnodeindex = vind;
        slot = sl;
    ...
    virtual UnifyConstraint* clone(void) const {
        return (new ConstraintOpInput(opindex, varnodeindex, slot))->copyid(this);
    }
    virtual bool step(UnifyState& state);
    virtual void collectTypes(vector<UnifyDatatype>& typelist) const;
    virtual int4 getBaseIndex(void) const {
...
public:
    ConstraintOpInputAny(int4 oind, int4 vind) {
        opindex = oind;
        varnodeindex = vind;
        maxnum = (opindex > varnodeindex) ? opindex : varnodeindex;
    }
    virtual UnifyConstraint* clone(void) const {
        return (new ConstraintOpInputAny(opindex, varnodeindex))->copyid(this);
    }
    virtual void initialize(UnifyState& state);
    virtual bool step(UnifyState& state);
    virtual void collectTypes(vector<UnifyDatatype>& typelist) const;
...
public:
    ConstraintOpOutput(int4 oind, int4 vind) {
        opindex = oind;
        varnodeindex = vind;
        maxnum = (opindex > varnodeindex) ? opindex : varnodeindex;
    }
    virtual UnifyConstraint* clone(void) const {
        return (new ConstraintOpOutput(opindex, varnodeindex))->copyid(this);
    }
    virtual bool step(UnifyState& state);
    virtual void collectTypes(vector<UnifyDatatype>& typelist) const;
    virtual int4 getBaseIndex(void) const {
...
public:
    ConstraintParamConstVal(int4 oind, int4 sl, uintb v) {
        maxnum = opindex = oind;
        slot = sl;
        val = v;
    }
    virtual UnifyConstraint* clone(void) const {
        return (new ConstraintParamConstVal(opindex, slot, val))->copyid(this);
    }
    virtual bool step(UnifyState& state);
    virtual void collectTypes(vector<UnifyDatatype>& typelist) const;
    virtual void print(ostream& s, UnifyCPrinter& printstate) const;
...
public:
    ConstraintParamConst(int4 oind, int4 sl, int4 cind) {
        opindex = oind;
        slot = sl;
        constindex = cind;
    ...
    virtual UnifyConstraint* clone(void) const {
        return (new ConstraintParamConst(opindex, slot, constindex))->copyid(this);
    }
    virtual bool step(UnifyState& state);
    virtual void collectTypes(vector<UnifyDatatype>& typelist) const;
    virtual int4 getBaseIndex(void) const {
...
public:
    ConstraintVarnodeCopy(int4 oldind, int4 newind) {
        oldvarindex = oldind;
        newvarindex = newind;
        maxnum = (oldvarindex > newvarindex) ? oldvarindex : newvarindex;
    }
    virtual UnifyConstraint* clone(void) const {
        return (new ConstraintVarnodeCopy(oldvarindex, newvarindex))->copyid(this);
    }
    virtual bool step(UnifyState& state);
    virtual void collectTypes(vector<UnifyDatatype>& typelist) const;
    virtual int4 getBaseIndex(void) const {
...
public:
    ConstraintVarCompare(int4 var1ind, int4 var2ind, bool val) {
        var1index = var1ind;
        var2index = var2ind;
        istrue = val;
    ...
    virtual UnifyConstraint* clone(void) const {
        return (new ConstraintVarCompare(var1index, var2index, istrue))->copyid(this);
    }
    virtual bool step(UnifyState& state);
    virtual void collectTypes(vector<UnifyDatatype>& typelist) const;
    virtual int4 getBaseIndex(void) const {
...
public:
    ConstraintDef(int4 oind, int4 vind) {
        opindex = oind;
        varindex = vind;
        maxnum = (opindex > varindex) ? opindex : varindex;
    }
    virtual UnifyConstraint* clone(void) const {
        return (new ConstraintDef(opindex, varindex))->copyid(this);
    }
    virtual bool step(UnifyState& state);
    virtual void collectTypes(vector<UnifyDatatype>& typelist) const;
    virtual int4 getBaseIndex(void) const {
...
public:
    ConstraintDescend(int4 oind, int4 vind) {
        opindex = oind;
        varindex = vind;
        maxnum = (opindex > varindex) ? opindex : varindex;
    }
    virtual UnifyConstraint* clone(void) const {
        return (new ConstraintDescend(opindex, varindex))->copyid(this);
    }
    virtual void buildTraverseState(UnifyState& state);
    virtual void initialize(UnifyState& state);
    virtual bool step(UnifyState& state);
...
public:
    ConstraintLoneDescend(int4 oind, int4 vind) {
        opindex = oind;
        varindex = vind;
        maxnum = (opindex > varindex) ? opindex : varindex;
    }
    virtual UnifyConstraint* clone(void) const {
        return (new ConstraintLoneDescend(opindex, varindex))->copyid(this);
    }
    virtual bool step(UnifyState& state);
    virtual void collectTypes(vector<UnifyDatatype>& typelist) const;
    virtual int4 getBaseIndex(void) const {
...
public:
    ConstraintOtherInput(int4 oind, int4 v_in, int4 v_out) {
        ...
        varindex_in = v_in;
        varindex_out = v_out;
        if (varindex_in > maxnum)
            maxnum = varindex_in;
        if (varindex_out > maxnum)
            maxnum = varindex_out;
    }
    virtual UnifyConstraint* clone(void) const {
        return (new ConstraintOtherInput(opindex, varindex_in, varindex_out))->copyid(this);
    }
    virtual int4 getBaseIndex(void) const {
        return varindex_out;
    }
...
public:
    ...
    virtual UnifyConstraint* clone(void) const {
        return (new ConstraintConstCompare(const1index, const2index, opc))->copyid(this);
    }
    virtual bool step(UnifyState& state);
    virtual void collectTypes(vector<UnifyDatatype>& typelist) const;
    virtual int4 getBaseIndex(void) const {
...
public:
    ...
    UnifyConstraint* getConstraint(int4 slot) const {
...
public:
    ...
    virtual UnifyConstraint* clone(void) const {
        return (new ConstraintNewOp(newopindex, oldopindex, opc, insertafter, numparams))->copyid(this);
    }
    virtual int4 getBaseIndex(void) const {
        return newopindex;
    }
...
public:
    ...
    virtual UnifyConstraint* clone(void) const {
        return (new ConstraintNewUniqueOut(opindex, newvarindex, sizevarindex))->copyid(this);
    }
    virtual int4 getBaseIndex(void) const {
        return newvarindex;
    }
...
public:
    ConstraintSetInput(int4 oind, RHSConstant* sl, int4 varind) {
        opindex = oind;
        slot = sl;
        varindex = varind;
        maxnum = (opindex > varindex) ? opindex : varindex;
    }
    virtual ~ConstraintSetInput(void) {
        delete slot;
    }
    virtual UnifyConstraint* clone(void) const {
        return (new ConstraintSetInput(opindex, slot->clone(), varindex))->copyid(this);
    }
    virtual int4 getBaseIndex(void) const {
        return varindex;
    }
...
public:
    ConstraintSetInputConstVal(int4 oind, RHSConstant* sl, RHSConstant* v, RHSConstant* sz) {
        opindex = oind;
        slot = sl;
        val = v;
        exprsz = sz;
...
public:
    ConstraintRemoveInput(int4 oind, RHSConstant* sl) {
        opindex = oind;
        slot = sl;
        maxnum = opindex;
    }
    virtual ~ConstraintRemoveInput(void) {
        delete slot;
    }
    virtual UnifyConstraint* clone(void) const {
        return (new ConstraintRemoveInput(opindex, slot->clone()))->copyid(this);
    }
    virtual int4 getBaseIndex(void) const {
        return opindex;
    }
...
public:
    ConstraintSetOpcode(int4 oind, OpCode oc) {
        opindex = oind;
        opc = oc;
        maxnum = opindex;
    }
    virtual UnifyConstraint* clone(void) const {
        return (new ConstraintSetOpcode(opindex, opc))->copyid(this);
    }
    virtual int4 getBaseIndex(void) const {
        return opindex;
    }
...
public:
    ...
    ~UnifyState(void);
    int4 numTraverse(void) const {
        return traverselist.size();
    }
    void registerTraverseConstraint(TraverseConstraint* t) {
        traverselist.push_back(t);
    }
    UnifyDatatype& data(int4 slot) {
        return storemap[slot];
    }
    TraverseConstraint* getTraverse(int4 slot) const {
        return traverselist[slot];
    }

// Port provenance: mechanically copied from Ghidra/Features/Decompiler/src/decompile/cpp/space.hh.
...
public:
    AddrSpace(AddrSpaceManager* m, const Translate* t, spacetype tp, const string& nm, bool bigEnd, uint4 size,
    ...
    virtual void encodeAttributes(Encoder& encoder, uintb offset,
                                  int4 size) const; ///< Encode an address and size attributes to a stream

// Port provenance: mechanically copied from Ghidra/Features/Decompiler/src/decompile/cpp/transform.hh.
...
public:
    ...
    bool restriction(int4 numLanes, int4 skipLanes, int4 bytePos, int4 size, int4& resNumLanes,
                     int4& resSkipLanes) const;
...
class TransformManager {
    ...
    void
    transformInputVarnodes(vector<TransformVar*>& inputList); ///< Remove old input Varnodes, mark new input Varnodes

// Port provenance: mechanically copied from Ghidra/Features/Decompiler/src/decompile/cpp/float.hh.
...
private:
    ...
    static double createFloat(bool sign, uintb signif,
                              int4 exp); ///< Create a double given sign, fractional, and exponent
...
public:
    ...
    int4 getExponent(uintb x) const {
        return extractExponentCode(x) - bias;

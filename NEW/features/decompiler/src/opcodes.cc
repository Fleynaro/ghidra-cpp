// Port provenance: mechanically copied from Ghidra/Features/Decompiler/src/decompile/cpp/opcodes.cc.
...
///  -  PTRADD     = LABEL
///  -  PTRSUB     = CROSSBUILD
static const char* opcode_name[] = {"BLANK",       "COPY",          "LOAD",           "STORE",       "BRANCH",
                                    ...
                                    "UNUSED1",     "FLOAT_NAN",     "FLOAT_ADD",      "FLOAT_DIV",   "FLOAT_MULT",
                                    "FLOAT_SUB",   "FLOAT_NEG",     "FLOAT_ABS",      "FLOAT_SQRT",  "INT2FLOAT",
                                    "FLOAT2FLOAT", "TRUNC",         "CEIL",           "FLOOR",       "ROUND",
                                    "BUILD",       "DELAY_SLOT",    "PIECE",          "SUBPIECE",    "CAST",
                                    "LABEL",       "CROSSBUILD",    "SEGMENTOP",      "CPOOLREF",    "NEW",
                                    "INSERT",      "EXTRACT",       "POPCOUNT",       "LZCOUNT"};

static const int4 opcode_indices[] = {0,  39, 37, 40, 38, 4,  6,  60, 7,  8,  9,  64, 5,  57, 1,  68, 66, 61, 71,
                                      55, 52, 47, 48, 41, 43, 44, 49, 46, 51, 42, 53, 50, 58, 70, 54, 24, 19, 27,
                                      21, 33, 11, 29, 15, 16, 32, 25, 12, 28, 35, 30, 23, 22, 34, 18, 13, 14, 36,
                                      31, 20, 26, 17, 65, 2,  73, 69, 62, 72, 10, 59, 67, 3,  63, 56, 45};

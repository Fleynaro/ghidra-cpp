...
// Port provenance: mechanically copied from Ghidra/Features/Decompiler/src/decompile/cpp/options.cc.
...
string OptionErrorTooManyInstructions::apply(Architecture* glb, const string& p1, const string& p2,
...
/// \brief Toggle whether disassembling bytes that can't be decoded or at a non-existent address is considered a fatal
/// error.
///

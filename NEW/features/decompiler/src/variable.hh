// Port provenance: mechanically copied from Ghidra/Features/Decompiler/src/decompile/cpp/variable.hh.
...
private:
    ...
    void merge(HighVariable* tv2, HighIntersectTest* testCache,
               bool isspeculative);    ///< Merge with another HighVariable taking into account groups
...
public:
    ...
    void groupWith(int4 off,
                   HighVariable* hi2);     ///< Put \b this and another HighVariable in the same intersection group
    ...
    Varnode*
    getNameRepresentative(void) const; ///< Get a member Varnode that dictates the naming of \b this HighVariable
    ...
    static int4 markExpression(Varnode* vn,
                               vector<HighVariable*>& highList); ///< Mark and collect variables in expression
};
...
class HighIntersectTest {
    ...
    static bool testBlockIntersection(HighVariable* a, int4 blk, const Cover& cover, int4 relOff,

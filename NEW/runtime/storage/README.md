...
- [`sqlite_projection_store.cppm`](sqlite_projection_store.cppm) persists applied-event identities, project metadata, checkpoints, and indexed starter rows in `projection.sqlite`.

...
- [`debugger.cppm`](debugger.cppm) defines backend-independent session, execution, process, thread, register, memory, stack, module, breakpoint, watchpoint, and event operations. Waiting operations return the established [`Task`](operation.cppm) type.

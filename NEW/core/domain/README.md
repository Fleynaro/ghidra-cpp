...
- `DecodedInstruction` is the transient numeric-address boundary; [`instruction.cppm`](instruction.cppm) remains the space-aware listing/persistence snapshot. [`services/sleigh/sleigh_runtime.cppm`](../../services/sleigh/sleigh_runtime.cppm) and [`services/decompiler/src/decompiler.cppm`](../../services/decompiler/src/decompiler.cppm) must alias the transient values instead of declaring service DTOs.

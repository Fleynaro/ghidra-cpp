...
Для быстрых понятных ответов на вопросы по архитектуре и исходникам используйте
[`FAQ_RU.md`](FAQ_RU.md). FAQ фиксирует проверенные ответы с рефами на код и
связанные документы; новые ответы на вопросы такого типа также нужно добавлять
туда.
